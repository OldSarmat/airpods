...
// function open(evt) активируем актив и указываем таргет, 
// с экому классу добавляем target.classList.add класс hoose__color-btn--active, 
// у остальных убираем item.classList.remove('choose__color-btn--active')
